...
export type anonymizeMeResponse200 = {
  data: void
  status: 200
}

export type anonymizeMeResponse401 = {
  data: void
  status: 401
}
    
export type anonymizeMeResponseSuccess = (anonymizeMeResponse200) & {
  headers: Headers;
};
export type anonymizeMeResponseError = (anonymizeMeResponse401) & {
  headers: Headers;
};

export type anonymizeMeResponse = (anonymizeMeResponseSuccess | anonymizeMeResponseError)

export const getAnonymizeMeUrl = () => {


  

  return `/api/auth/me/anonymize`
}

export const anonymizeMe = async (anonymizeAccountRequest: AnonymizeAccountRequest, options?: RequestInit): Promise<anonymizeMeResponse> => {
  
  return customFetch<anonymizeMeResponse>(getAnonymizeMeUrl(),
  {      
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export type exportMeResponse200 = {
  data: UserExport
  status: 200
}

export type exportMeResponse401 = {
  data: void
  status: 401
}
    
export type exportMeResponseSuccess = (exportMeResponse200) & {
  headers: Headers;
};
export type exportMeResponseError = (exportMeResponse401) & {
  headers: Headers;
};

export type exportMeResponse = (exportMeResponseSuccess | exportMeResponseError)

export const getExportMeUrl = () => {
...
export const exportMe = async ( options?: RequestInit): Promise<exportMeResponse> => {
  
  return customFetch<exportMeResponse>(getExportMeUrl(),
  {      
    ...options,
    method: 'GET'
